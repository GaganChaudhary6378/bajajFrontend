...
import { Select, MenuItem, FormControl, InputLabel, OutlinedInput, Chip, FormHelperText, Button, Typography } from '@mui/material';
  ...
  const renderFilteredData = () => {
    ...
    return (
      <div>
        ...
        {data?.numbers?.length === 0 && data?.alphabets?.length === 0 && data?.highest_lowercase?.length === 0 && (
      ...
      <div className="filter-section" style={{ marginBottom: '20px' }}>
        <FormControl fullWidth>
          ...
          >
            ...
            <MenuItem value="highest_lowercase">Highest Lowercase Alphabet</MenuItem>
          </Select>
